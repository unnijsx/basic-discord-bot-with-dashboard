...
router.get('/me', (req, res) => {
    if (req.user) {
        ...
        const isSuperAdmin = superAdmins.includes(req.user.discordId);
        console.log(`[Auth] User: ${req.user.discordId} | Admins: ${JSON.stringify(superAdmins)} | IsSuper: ${isSuperAdmin}`);
        res.json({ ...req.user.toObject(), isSuperAdmin });
    } else {
